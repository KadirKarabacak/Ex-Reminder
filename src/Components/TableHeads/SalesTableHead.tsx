...
export function SalesTableHead(props: EnhancedTableProps) {
    ...
    const tableHeadsEng = [
        // { label: "Company", key: "saleCompanyId" },
        { label: "Sale Date", key: "saleCreatedAt" },
        { label: "Sale Item", key: "saleItemId" },
        { label: "Item Amount", key: "saleItemAmount" },
        { label: "Item Price", key: "saleItemPrice" },
        { label: "Sale Description", key: "saleDescription" },
        "",
    ];

    const tableHeadsTr = [
        // { label: "Şirket", key: "saleCompanyId" },
        { label: "Satış Tarihi", key: "saleCreatedAt" },
        { label: "Satılan Malzeme", key: "saleItemId" },
        { label: "Malzeme Adet", key: "saleItemAmount" },
        { label: "Malzeme Fiyat", key: "saleItemPrice" },
        { label: "Açıklama", key: "saleDescription" },
        "",
    ];
