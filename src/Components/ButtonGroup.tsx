    ...
    <div>
      ...
      >
        ...
        >
          ...
          {tableName === 'sales' && formatTimestampToDate(row?.saleCreatedAt)}
        ...
        {tableName === 'warehouse' && (
          <div>
            <MenuItem onClick={handleOpenEditItemModal} disableRipple>
              <EditIcon />
              {t('Edit')}
            </MenuItem>
            <MenuItem onClick={handleOpenDetailItemModal} disableRipple>
              <ReadMoreIcon />
              {t('Detail')}
            </MenuItem>
            <MenuItem onClick={handleOpenDeleteItemModal} disableRipple>
              <DeleteOutline />
              {t('Delete')}
            </MenuItem>
          </div>
        ...
        {tableName === 'company' && (
          <div>
            <MenuItem onClick={handleOpenEditCompanyModal} disableRipple>
              <EditIcon />
              {t('Edit')}
            </MenuItem>
            ...
            <MenuItem onClick={handleOpenAddSaleModal} disableRipple>
              <PostAddIcon />
              {t('Make Sale')}
            </MenuItem>
            <MenuItem onClick={handleOpenAddAgreementModal} disableRipple>
              <HandshakeIcon />
              {t('Add Agreement')}
            </MenuItem>
            <MenuItem onClick={handleOpenNegotiateModal} disableRipple>
              <MoreTimeIcon />
              {t('Add Negotiate')}
            </MenuItem>
            <MenuItem onClick={handleOpenDeleteCompanyModal} disableRipple>
              <DeleteOutline />
              {t('Delete')}
            </MenuItem>
          </div>
        ...
        {tableName === 'sales' && (
          <div>
            <MenuItem onClick={handleOpenDeleteSaleModal} disableRipple>
              <DeleteOutline />
              {t('Delete')}
            </MenuItem>
          </div>
        ...
        {tableName === 'notifications' && (
          <div>
            <MenuItem onClick={handleOpenDeleteNotificationModal} disableRipple>
              <DeleteOutline />
              {t('Delete')}
            </MenuItem>
          </div>
